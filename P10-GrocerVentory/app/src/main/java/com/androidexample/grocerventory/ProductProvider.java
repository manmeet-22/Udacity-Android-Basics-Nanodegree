...
public class ProductProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String email = values.getAsString(ProductEntry.COLUMN_PRODUCT_DEALER);
        if (email == null) {
            throw new IllegalArgumentException("Product requires valid name");
        }

        String dealer = values.getAsString(ProductEntry.COLUMN_PRODUCT_EMAIL);
        if (dealer == null) {
            throw new IllegalArgumentException("Product requires valid name");
        }
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ProductEntry#COLUMN_PRODUCT_GENDER} key is present,
